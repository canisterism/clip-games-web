...
export const myReviewQuery = graphql(`
...
export function Game({ game }: PageProps) {
  ...
  const { data: myReviewData } = useQuery(myReviewQuery, {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-10">
        ...
        />
        <ReviewsArea reviews={game.reviews} myReview={myReview} />
        {myReview ? (
          <UpdateReviewModal
            myReview={myReview}
            isOpen={isReviewDialogOpen}
            setIsOpen={setIsReviewDialogOpen}
            onSubmitComplete={onSubmitReviewComplete}
          />
        ) : (
          <PostReviewModal
            gameId={game.id}
...
function ReviewsArea({
  ...
  reviews: GameQuery["game"]["reviews"];
  myReview: MyReviewQuery["myReview"];
}) {
  return (
    <div className="flex flex-col gap-4">
      <h2 className="text-3xl font-bold text-gray-100">レビュー</h2>
      <div className="flex flex-col gap-4">
        {myReview && <ReviewListItem review={myReview} />}
