...
export type GameQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, title: string, imageUrl?: string | null, reviews: Array<{ __typename?: 'Review', body: string, rating: number, createdAt: any }> } };
